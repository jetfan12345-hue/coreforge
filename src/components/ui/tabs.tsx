...
export function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        "inline-flex h-11 items-center justify-center rounded-[var(--radius-lg)] bg-[var(--color-surface-2)] p-1 text-[var(--color-muted)]",
        className,
      )}
      {...props}
    />
